...
public:
  ...
  void
  SetPopSummary (const std::string &PopClass,
          const std::string &attr1 = "", const std::string &value1 = "",
          const std::string &attr2 = "", const std::string &value2 = "",
          const std::string &attr3 = "", const std::string &value3 = "",
          const std::string &attr4 = "", const std::string &value4 = "");
  ...
  void
  SetCacheDecision (const std::string &CacheClass,
          const std::string &attr1 = "", const std::string &value1 = "",
          const std::string &attr2 = "", const std::string &value2 = "",
          const std::string &attr3 = "", const std::string &value3 = "",
          const std::string &attr4 = "", const std::string &value4 = "");
   ...
   */
  Ptr<FaceContainer>
  Install (const std::string &nodeName);
   ...
   */
  Ptr<FaceContainer>
  Install (Ptr<Node> node, const std::string brArray[], uint32_t size, bool needstats = true);

  void
  SetRatio(Ptr<Node> node, double r[], const std::string brArray[], uint32_t size);
  /*
   * Wenjie Define Optimal static caching placement (DASCache)
   */
  Ptr<FaceContainer>
  DASCacheInstall (Ptr<Node> node, std::vector<Name> content, const std::string brArray[], uint32_t size);

  /*
   * Added by Wenjie Li
   * Heuristic caching placement (StreamCache)
   */
  Ptr<FaceContainer>
  StreamCacheInstall (Ptr<Node> node, bool isedge, const std::string brArray[], uint32_t size);


  Ptr<FaceContainer>
  AdaptiveStreamInstall(Ptr<Node> node);
...
private:
  ...
  Ptr<NetDeviceFace>
  PointToPointNetDeviceCallback (Ptr<Node> node, Ptr<L3Protocol> ndn, Ptr<NetDevice> netDevice);
...
private:
  ...
  ObjectFactory m_bitrate_factory;

  ObjectFactory m_videostatFactory;
  ObjectFactory m_popsummaryFactory;
  ObjectFactory m_cachedecisionFactory;
