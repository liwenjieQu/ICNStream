 ...
 */
template class ContentStoreImpl<fixed_policy_traits>;
...
NS_OBJECT_ENSURE_REGISTERED_TEMPL(ContentStoreImpl, fixed_policy_traits);
...
template class ContentStoreImpl<FixedWithCountsTraits>;
NS_OBJECT_ENSURE_REGISTERED_TEMPL(ContentStoreImpl, FixedWithCountsTraits);
