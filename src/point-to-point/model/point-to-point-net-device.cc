...
PointToPointNetDevice::GetTypeId (void)
{
  static TypeId tid = TypeId ("ns3::PointToPointNetDevice")
    ...
    .AddAttribute ("Mtu", "The MAC-level Maximum Transmission Unit",
                   ...
                   MakeUintegerAccessor (&PointToPointNetDevice::MySetMtu,
                                         &PointToPointNetDevice::MyGetMtu),
...
uint32_t
PointToPointNetDevice::MyGetMtu (void) const
{
  NS_LOG_FUNCTION_NOARGS ();
  return m_mtu;
}
bool
PointToPointNetDevice::MySetMtu (uint32_t mtu)
{
  NS_LOG_FUNCTION (this << mtu);
  m_mtu = mtu;
  return true;
